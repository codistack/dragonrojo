...
export const defaultConfiguracion: ConfiguracionGeneral = {
  ...
  heroImage: 'https://images.unsplash.com/photo-1544025162-d76694265947?auto=format&fit=crop&q=80&w=1600',
  descripcionHero: 'Sabores autóctonos y auténticos del sur del Ecuador. Especialistas en Cuy Asado, Pollo al Carbón, Caldos Tradicionales, Tamales, Humitas y el mejor Morocho del Austro.',
  ...
  mapLinkDirecto: 'https://maps.google.com/?q=Cuenca+Ecuador+Comida+Tipica',
...
export const defaultPlatos: Plato[] = [
  ...
  {
    id: 'pollo-al-carbon',
    nombre: 'Pollo al Carbón estilo Dragón',
    descripcion: '1/2 Pollo marinado en hierbas locales y asado lentitamente a la leña. Acompañado de arroz con menestra de lenteja, papas fritas frito y ají de casa.',
    precio: 8.50,
    categoria: 'Platos Fuertes',
    imagenUrl: 'https://images.unsplash.com/photo-1598515214211-89d3c73ae83b?auto=format&fit=crop&q=80&w=800',
    destacado: true,
    disponible: true,
